...
import 'package:flutter_login/login/core/errors/exceptions.dart';
...
class LoginDatasourceImpl implements LoginDatasource {
  ...
  Future<String?> getToken() async {
    try {
      final sharedPrefs = await SharedPreferences.getInstance();
      return sharedPrefs.getString(SharedPreferencesKeys.token.name);
    } catch (e) {
      throw const ServerException();
    }
  }
  ...
  Future<bool> deleteToken() async {
    try {
      final sharedPrefs = await SharedPreferences.getInstance();
      return await sharedPrefs.remove(SharedPreferencesKeys.token.name);
    } catch (e) {
      throw const ServerException();
    }
  }
